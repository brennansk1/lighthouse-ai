...
def test_ct_returns_documents(mocked_http):
    mocked_http.get("https://clinicaltrials.gov/api/v2/studies").respond(
...
def test_who_returns_documents(mocked_http):
    mocked_http.get("https://ghoapi.azureedge.net/api/GHO").respond(
        200, json=WHO_GHO_JSON
    )
